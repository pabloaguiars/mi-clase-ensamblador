...
.data
	...
	MESSAGE DB 'Una máquina puede hacer el trabajo de cincuenta hombres ordinarios. Ninguna máquina puede hacer el trabajo de un hombre extraordinario.' ;MENSAJE A ESCRIBIR EN EL ARCHIVO
.code
	Limpiar:
		mov ax, 03h
		int 10h
	...
	lea DX, MESSAGE
	mov CX, 137 ;CX = CANTIDAD DE BYTES A ESCRIBIR
	mov AH, 40H
	int 21H
